defmodule ChineseDictionarySimplifiedTest do
  ...
  describe "Translate Chinese to English" do
    test "Translate 化石" do
      assert_value(
        ChineseDictionary.chinese_simplified_to_english("化石") == [
    ...
    test "Translate 一团乱糟" do
      assert_value(
        ChineseDictionary.chinese_simplified_to_english("一团乱糟") == [
          {"一团乱糟", "一團亂糟", "yi1 tuan2 luan4 zao1", "a chaotic mess"}
        ]
      )
    end
    ...
    test "Translate 活下" do
      assert_value(
        ChineseDictionary.chinese_simplified_to_english("活下") == [
    ...
    test "Translate 活着" do
      assert_value(
        ChineseDictionary.chinese_simplified_to_english("活着") == [
    ...
    test "Translate 北京周报" do
      assert_value(
        ChineseDictionary.chinese_simplified_to_english("北京周报") == [
          {"北京周报", "北京周報", "Bei3 jing1 Zhou1 bao4", "Beijing Review/also written 北京週報|北京周报"},
          {"北京周报", "北京週報", "Bei3 jing1 Zhou1 bao4", "Beijing Review"}
        ]
      )
    end
  ...
  describe "Test if not found" do
    test "Some english word" do
      assert_value(ChineseDictionary.chinese_simplified_to_english("Nothing") == [])
    end
  end
end
